...
| 스킬 | 사용 시점 |
|---|---|
| `gil-creative:design-prompt-builder` | 패턴 3(생성)·6(감사)이 본 가이드라인을 컴포넌트별 체크리스트로 참조 |
| `gil-creative:design-system-prep` | DESIGN.md Component recipes 품질 기준 |
| `gil-creative:design-slop-check` | 카피 중심 검수의 보완 — 컴포넌트 동작·레이아웃 품질은 본 스킬 |
| `gil-creative:design-system-library` | shadcn vanilla 컴포넌트 참조 마크업과 본 가이드라인의 짝 |
