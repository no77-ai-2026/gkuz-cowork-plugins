...
- **이미지 생성 실행·모델 선택·크레딧 고지 안 함** — `gil-creative:higgsfield-core` 계약에 위임한다.
...
| 스킬 | 시점 |
|---|---|
| `gil-creative:design-brand-visual` | 대안: 이미지 한 장만 필요할 때 |
| `gil-creative:design-brand-system` | 선행: 팔레트·타이포 기준 수립 |
| `gil-creative:design-tokens-transformer` | 선행: 토큰을 CSS로 |
| `gil-creative:design-slop-check` | 후속: 카피 AI 슬롭 점검 |
| `gil-creative:higgsfield-image` | 위임: 이미지 생성 |
| `gil-creative:higgsfield-video` | 위임: 스크럽용 영상 생성 |
| `gil-creative:higgsfield-assets` | 위임: 3D(GLB)·업스케일·누끼 |
| `gil-creative:higgsfield-identity` | 선행: 인물·마스코트 일관성 |
...
- 생성 실행·모델·비용: `gil-creative:higgsfield-core` 라이브 계약.
