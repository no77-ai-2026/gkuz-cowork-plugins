...
- 카피 검수 필요 → gil-creative:design-slop-check
```
...
| 스킬 | 사용 시점 |
|---|---|
| `gil-creative:design-brief` | 대안: 일반적 6요소 브리프 (시니어 패턴이 필요 없을 때) |
| `gil-creative:design-system-prep` | 선행: 디자인 시스템 자산 합성 |
| `gil-creative:design-slop-check` | 후속: 결과 카피 검수 |
| `gil:ux-designer` | 보조: Claude Design 외 UX 분석 |
| `gil:ux-researcher` | 보조: 사용자 리서치 단계 |
