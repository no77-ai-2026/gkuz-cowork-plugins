...
| 스킬 | 사용 시점 |
|---|---|
| `gil-creative:design-handoff-reader` | 선행: 번들에서 3계층 토큰 소스 추출 |
| `gil-creative:design-system-prep` | 선행: 자산→DESIGN.md 합성(토큰 원천) |
| `gil-creative:design-system-library` | 보조: 75개 브랜드 토큰을 변환 입력으로 |
| `gil-creative:design-sync-upload` | 후속: 변환된 토큰을 Claude Design에 업로드 |
