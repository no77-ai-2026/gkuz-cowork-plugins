...
[책임 경계] vs gil-commerce:product-detail: 이 스킬=단독 전환 랜딩 1페이지(캠페인·이벤트·리드 수집), 저 스킬=카탈로그 제품 상세 페이지(스마트스토어·쿠팡·카카오 규격, 옵션·비교).
...
- `gil-commerce:product-detail` — 제품 상세 페이지 (이커머스)
- `gil-creative:sns-content` — 소셜미디어 콘텐츠
- `gil-creative:copywriting` — 광고 카피 단독 작성
- `gil-creative:blog` — SEO 블로그 포스팅

## 이 스킬을 사용하지 말아야 할 때

- 블로그 포스팅: `gil-creative:blog` 스킬 사용
- SNS 포스팅: `gil-creative:sns-content` 스킬 사용
- 이메일 뉴스레터: `gil-creative:newsletter` 스킬 사용
- 제품 상세페이지: `gil-commerce:product-detail` 스킬 사용
- 데이터 대시보드: `gil:data-visualizer` 스킬 사용
