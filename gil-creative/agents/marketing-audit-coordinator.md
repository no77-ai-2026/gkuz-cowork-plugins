...
1. `gil-creative:seo-audit` — SEO 감사
2. `gil-creative:landing-page-conversion-audit` — 랜딩 전환율 감사
3. `gil-creative:pixel-audit` — 픽셀·추적 감사
4. 통합 감사 리포트 정리 → (텍스트) `gil:ai-slop-reviewer`
...
- 리포트 텍스트는 `gil:ai-slop-reviewer`로 다듬되 수치는 보존.
