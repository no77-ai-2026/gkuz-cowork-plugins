...
1. `gil-creative:design-brief` — 디자인 브리프 작성
2. `gil-creative:design-system-prep` — 디자인 시스템·토큰 준비
3. `gil-creative:design-prompt-builder` — 핸드오프 프롬프트 구성
4. `gil-creative:design-handoff-reader` — 핸드오프 결과 해석
5. `gil-creative:design-slop-check` — 디자인 슬롭 검수(게이트)
