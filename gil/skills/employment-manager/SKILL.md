...
> 평가 루브릭 점수표·온보딩 체크리스트 표 같은 **표 산출물**은 위 텍스트 체인 대상이 아닙니다. 표가 필요하면 `gil:xlsx-creator`로 라우팅하세요.
...
- **성과평가 체계 설계**: OKR/KPI 설정 및 평가 면담은 `gil:performance-review` 스킬이 더 적합합니다.
