...
특허 목록·핵심 청구항 요약·IPC 분류별 분포를 정리하고, 선행기술 조사·FTO·출원서가 필요하면 gil:patent-analyzer로 이어집니다.
...
- "선행기술 조사" → gil:patent-analyzer 스킬 연계
- "특허 맵 분석" → gil:patent-analyzer 스킬 연계
- "출원서 작성" → gil:patent-analyzer 스킬 연계
- "FTO 분석" → gil:patent-analyzer 스킬 연계
...
- 선행기술 조사, FTO 분석, 출원서 작성이 필요한 경우 gil:patent-analyzer 스킬로 연계합니다.
