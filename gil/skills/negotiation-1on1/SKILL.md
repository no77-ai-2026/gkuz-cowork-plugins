...
- **gil:conflict-handler**: 면담이 갈등·거절 상황과 얽힐 때
- **gil:feedback-loop**: 면담에서 피드백을 주고받을 때
- **gil:report-speak**: 면담에서 결론 먼저 설득 구조 적용
- **gil-business**: 영업 제안·계약 협상 문서가 필요할 때

## 이 스킬을 사용하지 말아야 할 때

- **공식 성과평가·인사 면담 진행**: 평가 면담은 `gil:performance-review`를 사용한다.
