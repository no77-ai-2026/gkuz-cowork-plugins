...
- `gil:humanize-korean` — 검수된 본문을 자연스러운 한국어 실무 문체로 다듬습니다.
...
- **법적 구속력이 있는 계약서 작성** → 법률 전문가 검토가 필요합니다. gil:contract-review를 함께 사용하세요
- **실제 발주 처리 또는 시스템 입력** → ERP나 조달 시스템에 직접 접속해야 합니다
- **인사·노무 관련 절차** → gil:people-operations 스킬이 더 적합합니다
