...
감사 인사부터 적용 인증, 성과 수치, 영상 후기, 심층 인터뷰까지 시점별 톤에 맞춰 후기를 회수하고, gil-creative:copywriting → gil:ai-slop-reviewer → gil:korean-spell-check 체인으로 자연스럽게 다듬어 드립니다.
[책임 경계] vs gil-creative:copywriting: 이 스킬=강의 수강생 후기 30일 회수 시퀀스, 저 스킬=범용 마케팅 카피.
...
**체인**
후기 카피 5종 생성 시: `gil-creative:copywriting → gil:ai-slop-reviewer → gil:korean-spell-check`
...
```
Step 1: gil-creative:copywriting → 시점별 톤·목적·길이 기준 후기 카피 초안 생성
Step 2: gil:ai-slop-reviewer → AI 패턴 제거, 자연스러운 사람 문체 검수
Step 3: gil:korean-spell-check → 맞춤법 검사
...
- 심층 인터뷰 → 블로그 사례 기사 (`gil-creative:blog`) → SEO 누적
- 정량 후기 → 사업계획서·IR·강의 소개서 신뢰 지표 (`gil:strategy-planner`)

---

## 관련 스킬

- `gil-creative:copywriting` — 체인 1단계: 후기 카피 초안 생성
- `gil:ai-slop-reviewer` — 체인 2단계: AI 패턴 후처리
- `gil:korean-spell-check` — 체인 3단계: 맞춤법 검사
- `gil:course-operations-manual` — 강의 운영 매뉴얼 (선행 스킬)
- `gil-media` — D+30 영상 후기 재가공 (선택)
- `gil-creative:blog` — D+30 심층 인터뷰 블로그 사례 기사 (선택)

---

## 이 스킬을 사용하지 말아야 할 때

- 강의와 무관한 일반 마케팅 후기·리뷰 카피 → `gil-creative:copywriting` 직접 사용
- 강의 운영 매뉴얼·시간표·동선 설계 → `gil:course-operations-manual` 사용
- 카톡·알림톡·이메일 자동 발송 인프라 설정 → 외부 발송 도구 사용 (본 스킬은 카피·가이드 생성만)
- 학습 평가·시험 채점 → `gil:assessment-creator` 사용
