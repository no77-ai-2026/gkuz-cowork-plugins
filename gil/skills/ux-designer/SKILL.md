...
[책임 경계] vs gil:ux-researcher: ux-designer=휴리스틱·접근성·플로우 평가, ux-researcher=인터뷰·페르소나·VOC 리서치
...
| 스킬 | 사용 시점 |
|------|----------|
| `gil:ux-researcher` | 선행 작업: 사용자 리서치가 필요한 경우 |
| `gil:spec-writer` | 후속 작업: UX 사양서 작성 필요 시 |
| `gil-creative:landing-page` | 대안: 랜딩 페이지 UX 개선 필요 시 |
