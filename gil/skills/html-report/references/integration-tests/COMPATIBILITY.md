...
## 1. gil:executive-summary → mode=status
...
```
gil:executive-summary → gil:ai-slop-reviewer → gil:html-report mode=status
```
...
## 2. gil:financial-statements → mode=financial
...
```
gil:financial-statements → gil:html-report mode=financial
```
...
## 3. gil:sbiz365-analyst → mode=plan
...
```
gil:sbiz365-analyst → gil:ai-slop-reviewer → gil:humanize-korean → gil:html-report mode=plan
```
...
## 4. gil:daily-briefing → mode=status (daily variant)
...
```
gil:daily-briefing → gil:html-report mode=status
```
...
|---|---|---|---|---|
| gil:executive-summary | status | 7개 | 3개 | **4** |
| gil:financial-statements | financial | 6개 | 4개 | **4** |
| gil:sbiz365-analyst | plan | 6개 | 3개 | **4** |
| gil:daily-briefing | status | 5개 | 3개 | **4** |
