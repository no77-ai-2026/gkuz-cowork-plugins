...
[책임 경계] vs gil:ux-designer: ux-researcher=정성/정량 리서치(인터뷰·페르소나·VOC), ux-designer=디자인 평가(휴리스틱·접근성·플로우)
...
| 스킬 | 사용 시점 |
|------|----------|
| `gil:spec-writer` | PRD·기능 명세 작성 |
| `gil:draft-response` | 고객 CS 응답 초안 작성 |
| `gil-creative:performance-report` | 마케팅 데이터 분석 |
