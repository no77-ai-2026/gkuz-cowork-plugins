...
1. `gil:goal-planner` — 목표 설정
2. `gil:habit-routine` — 습관·루틴 설계
3. `gil:time-system` — 시간 운영 체계
4. `gil:weekly-report` — 주간 보고
5. `gil:retro-builder` — 회고
...
- 회고·보고 텍스트는 필요 시 `gil:ai-slop-reviewer`로 다듬습니다.
