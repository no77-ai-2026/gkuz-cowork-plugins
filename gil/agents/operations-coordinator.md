...
1. `gil:process-manager` — 프로세스 정의·개선
2. `gil:vendor-manager` — 벤더 관리
3. `gil:status-reporter` — 상태 보고 정리
4. (보고 텍스트) → `gil:ai-slop-reviewer`
...
- 보고 텍스트는 `gil:ai-slop-reviewer`로 다듬습니다.
