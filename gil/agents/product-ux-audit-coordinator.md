...
1. `gil:ux-researcher` — 사용자 리서치·인사이트
2. `gil:ux-designer` — UX 설계·플로우
3. `gil:spec-writer` — 기능 스펙 문서
4. `gil:roadmap-manager` — 우선순위·로드맵
5. (문서 텍스트) → `gil:ai-slop-reviewer`
...
- 문서 텍스트는 `gil:ai-slop-reviewer`로 다듬습니다.
