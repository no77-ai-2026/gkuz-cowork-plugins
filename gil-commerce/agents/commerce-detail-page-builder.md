...
**공통 선행**: `gil-commerce:detail-page-planner` — 구조·섹션·원 메시지 기획

**A. 글 중심 (구 content-detail-orchestrator)**
1. `gil-commerce:product-detail` — 제품 상세 콘텐츠 작성
2. `gil-creative:copywriting` — 핵심 카피 다듬기

**B. 이미지 중심**
1. `gil-commerce:product-photo-brief` — 제품 촬영/이미지 브리프
2. `gil-commerce:commerce-product-image-pipeline` — 상세 이미지 제작 파이프라인
...
- 상세 카피는 `gil:ai-slop-reviewer`(필수) → `gil:humanize-korean`로 마감.
