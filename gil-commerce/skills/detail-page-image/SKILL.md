...
gil-creative:higgsfield-image(Nano Banana Pro 등 11개 모델)로 13장의 이미지를 생성한 뒤
...
gil-creative:higgsfield-image를 백엔드로 사용하여 카테고리별 비주얼 톤이 일관된 13장의 섹션 이미지를 만들고,
...
### 3단계: 이미지 생성 (gil-creative:higgsfield-image)
...
- shadcn/ui 기반 웹 상세페이지: `gil-commerce:product-detail`
