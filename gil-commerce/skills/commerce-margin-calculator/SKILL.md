...
[책임 경계] 상품별 마진·엔드 ROAS(본전 ROAS)·손익분기 광고비 자동 계산 전담. 부가세·플랫폼 수수료·쿠폰·할인 모두 반영한 정확한 마진 산출. 페어 스킬 gil-commerce:marketplace-coupang-ads(쿠팡 광고 운영 의사결정)와 명확히 구분 — 본 스킬은 마진·ROAS 계산 전담, 페어는 캠페인 분류·의사결정.
...
| 페어 스킬 | 차이 |
|----------|------|
| `gil-commerce:marketplace-coupang-ads` | 쿠팡 광고 캠페인 분류·의사결정 (본 스킬: 마진·ROAS 계산만) |
...
| 광고 운영 연계 | 별도 | `gil-commerce:marketplace-coupang-ads`와 자동 체인 |
...
- 상품별 마진 분해에 '마진 누수(할인·수수료·배송)' 진단 축과 카테고리 벤치마크 대조 절차를 추가. 가격 시나리오 비교는 gil-commerce:price-check와 페어.
