...
- 카피(러시아어 우선) → `gil-creative:copywriting`.
- 이미지 → `gil-commerce:detail-page-image` / `gil-creative:gemini-3-image-prompt`.
...
```
gil-creative:copywriting  (러시아어 매물 카피)
  → gil-commerce:detail-page-image / gil-creative:gemini-3-image-prompt  (실물 사진 보정)
  → marketplace-olx  (본 스킬: 등록·노출)
  → gil-creative:campaign-planner  (유료 노출·광고)
```
