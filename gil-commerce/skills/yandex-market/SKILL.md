...
- SEO는 `gil-creative:seo-audit`(uz-seo-yandex), 캠페인은 `gil-creative:campaign-planner`(uz-marketing-channels).

### 4. 상품 카피·이미지

러시아어 카피 → `gil-creative:copywriting`. 이미지 → `gil-creative:gemini-3-image-prompt`.
...
```
gil-creative:seo-audit (uz-seo-yandex)  (Yandex SEO 진단)
  → gil-creative:copywriting  (러시아어 카피)
  → gil-creative:gemini-3-image-prompt  (이미지)
  → yandex-market  (본 스킬: 입점·Direct 광고)
  → marketplace-uzum  (UZ 실판매 연계)
  → gil:data-explorer  (성과 분석)
```
