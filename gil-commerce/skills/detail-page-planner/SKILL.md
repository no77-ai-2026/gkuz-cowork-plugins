...
완성한 기획안은 gil-commerce:detail-page-copy(카피) → gil-commerce:product-detail(코드) → gil-commerce:detail-page-image(이미지)로 이어집니다.
[책임 경계] vs 페어 스킬: 이 스킬=기획·전략, gil-commerce:detail-page-copy=13섹션 카피, gil-commerce:product-detail=코드, gil-creative:landing-page=단독 랜딩 1페이지.
...
| 단계 | 스킬 | 산출물 |
|------|------|--------|
| 1. 기획·전략 (★ **본 스킬**) | `gil-commerce:detail-page-planner` | **Brief** (원 메시지·오프닝·본문 뼈대·채널·이미지 체크리스트) |
| 2. 카피 | `gil-commerce:detail-page-copy` | 13섹션 감정여정 JSON |
| 3. 코드 | `gil-commerce:product-detail` | shadcn/ui React 또는 HTML |
...
2. 카피 JSON 산출 후 → gil-commerce:product-detail "Brief + Copy"
...
→ Brief 완성 후: gil-commerce:detail-page-copy → product-detail → gil-commerce:detail-page-image 순차 위임
...
- "상세페이지 코드 만들어줘" → `gil-commerce:product-detail` (shadcn/ui 컴포넌트)
- "상세페이지 이미지 합성해줘" → `gil-commerce:detail-page-image` (1080×12720 PNG)
- "랜딩 페이지 만들어줘" → `gil-creative:landing-page` (단독 전환 1페이지)
...
- after: gil-commerce:detail-page-copy → product-detail → gil-commerce:detail-page-image 순차 체이닝
