...
코드 생성 전에 디자인 톤(색·모드·모서리·효과)을 먼저 묻습니다. 기획은 gil-commerce:detail-page-planner, 카피는 gil-commerce:detail-page-copy, 이미지는 gil-commerce:detail-page-image로 이어집니다.
[책임 경계] vs 페어 스킬: 이 스킬=코드 산출, gil-commerce:detail-page-copy=13섹션 카피 JSON, gil-creative:landing-page=단독 전환 랜딩 1페이지.
...
- `gil-creative:landing-page` — 랜딩 페이지 (단독 전환 목적)
- `gil-creative:sns-content` — 소셜미디어 콘텐츠
- `gil-creative:copywriting` — 광고 카피

## 이 스킬을 사용하지 말아야 할 때

- 블로그 포스팅/리뷰 글: `gil-creative:blog` 스킬 사용
- SNS 포스팅: `gil-creative:sns-content` 스킬 사용
- 랜딩 페이지: `gil-creative:landing-page` 스킬 사용
- 광고 카피 단독 작성: `gil-creative:copywriting` 스킬 사용
